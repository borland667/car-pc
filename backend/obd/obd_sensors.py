# coding: utf-8
# https://github.com/peterh/pyobd/blob/master/obd_sensors.py
...
SENSORS = [
    ...
    Sensor("Short Term Fuel Trim - Bank 1", "0108", fuel_trim_percent ,"%"      ),
    Sensor("Long Term Fuel Trim - Bank 2", "0109", fuel_trim_percent ,"%"      ),
    Sensor("Fuel Rail Pressure - Bank 2", "010A", cpass             ,""       ),
