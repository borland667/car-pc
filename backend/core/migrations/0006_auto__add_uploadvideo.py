...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_uploadvideo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_path', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('source_md5', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'core', ['UploadVideo'])


    def backwards(self, orm):
        # Deleting model 'UploadVideo'
        db.delete_table(u'core_uploadvideo')
    ...
    models = {
        ...
        u'core.uploadvideo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source_md5': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
