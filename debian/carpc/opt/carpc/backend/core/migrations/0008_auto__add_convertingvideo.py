...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConvertingVideo'
        db.create_table(u'core_convertingvideo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_path', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('source_size', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
            ('destination_path', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dc', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['ConvertingVideo'])


    def backwards(self, orm):
        # Deleting model 'ConvertingVideo'
        db.delete_table(u'core_convertingvideo')
    ...
    models = {
        ...
        u'core.convertingvideo': {
            'Meta': {'object_name': 'ConvertingVideo'},
            'dc': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
